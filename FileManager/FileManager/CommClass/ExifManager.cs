...
//Nicely formatted well-known properties
...
// 
        public Int16 ISO
        {
            get
            {
                return this.GetPropertyInt16((int)TagNames.ExifISOSpeed);
            }
        }
...
// 
        public double SubjectDistance
        {
            get
            {
                return this.GetPropertyRational((int)TagNames.ExifSubjectDist).ToDouble();
            }
        }
...
// 
        public double FocalLength
        {
            get
            {
                return this.GetPropertyRational((int)TagNames.ExifFocalLength).ToDouble();
            }
        }
...
//Support methods for working with EXIF properties
